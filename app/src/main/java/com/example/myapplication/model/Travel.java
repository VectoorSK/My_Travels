...
public class Travel {
    ...
    public Travel(Integer id, String country, String code, String continent, String flag, String date_from, String date_to, String desc, String steps, List<Step> steps_array) {
        this.id = id;
